...
from unsloth import FastLanguageModel, FastModel, FastSentenceTransformer
...
def fetch_topic_patent(patent_number: str) -> str:
    # Safe globbing to handle missing files
    try:
...
# Save the adapter explicitly via the internal PEFT model
